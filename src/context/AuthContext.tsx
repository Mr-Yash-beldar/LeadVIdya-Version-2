...
interface AuthContextData {
  ...
  verifyAndLogin: (data: any) => Promise<void>;
...
export const AuthProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  const contextValue = React.useMemo(() => ({
    ...
    isServerUp,
    login,
    register: async (data: any) => { return { code: "1234" }; }, // mock implementation
    verifyAndLogin: async (data: any) => { }, // mock implementation
    logout,
    completeOnboarding,
    refreshProfile,
    checkServerStatus
  }), [user, loading, isFirstLaunch, isServerUp, logout, refreshProfile, checkServerStatus]);
